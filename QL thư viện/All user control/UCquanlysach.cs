...
namespace QL_thư_viện.All_user_control
{
    public partial class Quản_lý_sách : UserControl
    {
        ...
        {
            constr = @"Data Source=DESKTOP-9JJTF2A\SQLEXPRESS;Initial Catalog=""QLthuvien (1)"";Integrated Security=True;TrustServerCertificate=True";
            ...
            Dictionary<string, string> mapping = new Dictionary<string, string>
{
    ...
    { "Kho", "Ten_Kho" }
            ...
            sql = $"Select DISTINCT  {tenCotThucTe} From chitietsach_full  ";
            ...
            Dictionary<string, string> mapping = new Dictionary<string, string>
{
    ...
    { "Kho", "Ten_Kho" }
            ...
            string sql = $"SELECT Ma_Sach,Ten_Dau_Sach,Nam_Xuat_Ban,Gia_Bia,Ten_NXB,Ten_Kho,Ten_Chu_De,Ten_The_Loai,Ten_Tac_Gia, Ten_Tinh_Trang FROM [dbo].[ChiTietSach] " +
