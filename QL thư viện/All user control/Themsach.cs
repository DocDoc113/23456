...
namespace QL_thư_viện.All_user_control
{
    public partial class Themsach : Form
    {
        ...
        private void comMaTacGia_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void Themsach_Load(object sender, EventArgs e)
        {
            ...
            chcomTacGia.Items.Add("null");  // Thêm một item vào CheckedListBox
            ...
            daTG1.Fill(dtTG1);
            // Đổ dữ liệu vào CheckedComboBox 
